...
<body>
<table width="1130" height="816" border="0" align="center" bgcolor="#CCCCCC">
  <tr>
    <td height="230" colspan="2"><img src="Imagenes/54654.png" width="1281" height="307" /></td>
  </tr>
  <tr>
    <td width="1174" height="269" bgcolor="#CCCCCC"><form id="form2" name="form2" method="post" action="negocio.php">
        <label></label>
        ...
        <div align="center"><a href="Demalas.php"> ¿Olvidaste Tu Contraseña? </a><br />
          <a href="#">&iquest;Deseas Crear Cuenta?</a></div>
        </label>
        <label></label>
      </form></td>
    <td width="103" bgcolor="#CCCCCC"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
  ...
  <tr>
    <td height="230" colspan="2" background="Imagenes/94656.png"><label></label>
    <p align="left">&nbsp;</p></td>
  </tr>
</table>
</body>
